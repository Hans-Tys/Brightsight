...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/data/sites/web/brightsightstudio/www/core/modules/system/templates/form-element-label.html.twig");
    }
