...
$context["item"], "in_active_trail", [], "any", false, false, true, 46)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/navigation/menu--toolbar.html.twig", "/data/sites/web/brightsightstudio/www/core/themes/claro/templates/navigation/menu--toolbar.html.twig");
    }
